...
/**
 * Generates an improved HTML report with embedded data
 */
...
<head>
    ...
    <meta name="description" content="Daily updated list of flash sales and special offers for phones and laptops under 10,000 KES from popular Kenyan online shops">
    <style>
        * {
        ...
        .laptop { background: linear-gradient(135deg, #6a11cb 0%, #2575fc 100%); }
        .phone { background: linear-gradient(135deg, #ff416c 0%, #ff4b2b 100%); }
        .product h3 {
            margin: 0 0 15px 0;
            color: #212529;
            font-size: 1.1rem;
...
<body>
    <header>
        ...
        <div class="subtitle">Daily updated flash sales for phones & laptops under KES 10,000</div>
    </header>
    ...
    <div class="summary">
        ...
        <div class="summary-item">
            ...
            <div class="summary-label">Laptops</div>
        </div>
        <div class="summary-item">
            <div class="summary-value" id="phone-deals">0</div>
            <div class="summary-label">Phones</div>
        </div>
        <div class="summary-item">
            <div class="summary-value" id="avg-discount">0%</div>
            <div class="summary-label">Avg. Discount</div>
        </div>
        <div class="summary-item">
            <div class="summary-label last-updated">Last updated: <span id="timestamp">Loading...</span></div>
        </div>
    </div>
    ...
    <footer>
        <p>Data automatically updated daily | Source: Jumia Kenya</p>
        <p>This is an unofficial scraper project for educational purposes only</p>
    </footer>
    ...
    <script>
        ...
        function calculateStats(items) {
            ...
            const avgDiscount = validDiscounts > 0 ? Math.round(totalDiscount / validDiscounts) : 0;
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            document.getElementById('avg-discount').textContent = stats.avgDiscount + '%';
